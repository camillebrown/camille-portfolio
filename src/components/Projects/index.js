        ...
        <div className="proj-container" id='work'>
            <div className="info-wrapper">
                ...
                <p className="proj-desc">
                    I create websites with attention to detail and design accuracy. I look forward  to helping you in all of the stages of your digital project: strategy, design, and web development.
            </p>
            </div>
            <div className="proj-wrapper">
                ...
                <ProjectCard>
                    ...
                    <p className="proj-p">Find recipes and add them to your own personalized cookbook or create and save your own recipes!</p>
                </ProjectCard>
                <ProjectCard>
